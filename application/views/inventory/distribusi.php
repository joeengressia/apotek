...
function cetak_distribusi(id_distribusi) {
    ...
    window.open('<?= base_url('inventory/manage_distribusi/cetak') ?>?id='+id_distribusi, 'distribusi Cetak', 'width='+dWidth+', height='+dHeight+', left='+x+',top='+y);
}
