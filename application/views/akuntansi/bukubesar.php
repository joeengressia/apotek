...
function create_win_jurnal() {
    var str = '<div class="data-input" id="opennewwind">'+
        ...
        '<tr><td>Ket. Transaksi:</td><td><?= form_textarea('keterangan','','') ?>'+
        ...
        '<tr><td>Nilai (Rp.):</td><td><span class="label" id="nilai_label"></span></table>'+
        '</form>'+
    '</div>';
    $('#loaddata').append(str);
    $('#nilai').blur(function() {
        ...
        <div id="tabs-1">
            ...
            <table width="100%" class="inputan">
                ...
                <tr><td></td><td>
                    ...
                    <?= form_button('', 'Jurnal Transaksi', 'id=addjurnal') ?>
                    <?= form_button(null, 'Set Neraca Awal', 'id=set') ?>
                    </td></tr>
            </table>
            <?= form_close() ?>
            <div id="result"></div>
