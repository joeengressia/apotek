...
<div class="kegiatan">
    <script type="text/javascript">
        ...
        function edit_produk_asuransi(id, nama,reim){
        ...
        <div id="tabs-1">
            <?= form_open('', 'id=formadd') ?>
                <table width="100%" class="inputan">
                    <tr><td>Nama Produk</td><td><?= form_input('nama', '', 'id=nama size=30') ?><?= form_hidden('id_produk') ?></td></tr>
                    <tr><td>Reimbursement (%)</td><td><?= form_input('reimbursement','', 'id=reim size=5 onkeyup=Angka(this)') ?></td></tr>
