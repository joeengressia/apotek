...
<div class="kegiatan">
    ...
    <div class="data-input">
        <table width="100%" class="inputan">Parameter</legend>
            ...
            <?= form_open('laporan/resep', 'id=forminforesep') ?>
                ...
                <tr><td>Nama Apoteker:</td><td><?= form_input('apoteker',isset($_GET['awal'])?$_GET['apoteker']:NULL,'size=40 id=apoteker') ?> <?= form_hidden('id_apoteker', isset($_GET['awal'])?$_GET['id_apoteker']:NULL) ?>
    ...
    <div class="data-list">
        ...
        <tr>
            ...
            <th width="10%">Unit</th>
            <th width="20%">Apoteker</th>
            <th width="5%">No. R/</th>
            <th width="5%">Jumlah <br/>Permintaan</th>
            <th width="10%">Aturan <br/> Pakai</th>
            <th width="2%">Iterasi</th>
            <th width="10%">Jasa<br/> Apt.</th>
        </tr>
        <?php
        if (isset($_GET['awal'])) {
        $total = 0;
        ...
        <tr class="<?= ($key%2==1)?'even':'odd' ?>">
            <td align="center"><?= ($no !== $data->id)?anchor('pelayanan/resep/'.$data->id, $data->id, 'class=salinresep title="Klik untuk detail salinan resep"'):NULL ?></td>
            <td align="center"><?= ($no !== $data->id)?datetime($data->waktu):NULL ?></td>
        ...
        <tr>
            <td colspan="11" align="right">Total Bia. Apoteker(Rp.)</td>
