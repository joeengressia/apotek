...
<script type="text/javascript">
    ...
    function cetak_jasa_klinis() {
        var id_dokter = $('input[name=id_nakes]').val();
        var awal      = $('#awal').val();
        var akhir     = $('#akhir').val();
        ...
        window.open('laporan/cetak_jasa_klinis/?id='+id_dokter+'&awal='+awal+'&akhir='+akhir, 'Penjualan Cetak', 'width='+dWidth+', height='+dHeight+', left='+x+',top='+y);
    }
