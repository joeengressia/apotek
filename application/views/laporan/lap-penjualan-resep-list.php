...
<table cellspacing="0" width="130%" class="list-data">
<thead>
    <tr class="italic">
        <th width="3%">No.</th>
        ...
        <th width="8%">Diskon <br/>Rp.</th>
        <th width="8%">Diskon <br/>%</th>
        <th width="5%">PPN %</th>
        <th width="8%">Tuslah <br/>RP.</th>
        <th width="8%">Embalage<br/> RP.</th>
...
<tbody>
    ...
    ?>
        <tr>
            <td colspan="15" align="right">TOTAL</td><td align="right"><b><?= rupiah($total_nota) ?></b></td>
        </tr>
</tbody>
</table>
</div>