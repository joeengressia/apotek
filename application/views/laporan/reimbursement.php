...
$(function() {
    ...
    $('#form_reimbursement').submit(function(e) {
        e.preventDefault();
    ...
    <div id="tabs">
        ...
        <div id="tabs-1">
            ...
            <table width="100%" class="inputan">
                ...
                <tr><td></td><td><?= form_button(null, 'Cari', 'id=search') ?> <?= form_button('Reset', 'Reset','id=reset') ?> <?= form_button(null, 'Cetak Excel', 'id=cetak') ?>
            </table>
            <?= form_close() ?>
