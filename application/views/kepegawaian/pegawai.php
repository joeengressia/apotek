...
<div class="kegiatan">
    ...
    <div id="form_baru" class="data-input" style="display: none;position: relative; background: #fff; padding: 10px;">
        ...
        <table width="100%" class="inputan">
            <tr><td>Kualifikasi Pendidikan:</td><td>
            <?= form_dropdown('jenjang_baru', $pendidikan, null, 'id=jenjang_baru') ?></td></tr>
            <tr><td></td><td><?= form_input('jurusan_baru', '', 'id=jurusan_baru size=30 class=input-text') ?></td></tr>
            <tr><td>Jumlah Kebutuhan:</td><td><?= form_input('jumlah', '', 'id=jumlah class=angka') ?>
                <tr><td>Jabatan:</td><td><?= form_dropdown('jabatan', $jabatan, null, 'id=jabatan') ?></td></tr>
        </table>
        <fieldset>
